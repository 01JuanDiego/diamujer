let codigos = {
    "23": ["Esposita mía", "Amorcita, eres una mujer maravillosa, fuerte y llena de una luz que ilumina todo a su alrededor ✨. Que hoy y siempre la vida te regale el amor, el reconocimiento y las oportunidades que mereces, porque eres especial en cada sentido. Sigue brillando con tu esencia única y conquistando el mundo (como me conquistaste a mí) con esa magia que solo tú tienes. Sin ustedes las mujeres (en especial tú), el mundo perdería su color y su esencia. Gracias por existir, por ser parte de mi vida y por hacer de cada día algo más hermoso. 💖🌸💫"],
